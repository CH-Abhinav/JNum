...
public class TrigOps {
    ...
    public static NDArray sinFloat(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            ...
            resArray.getData().set(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES,(float) Math.sin(val));
        }
        return resArray;
    }
    ...
    public static NDArray sinDouble(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            ...
            resArray.getData().set(ValueLayout.JAVA_DOUBLE, i * DB_BYTES, Math.sin(val));
        }
    ...
    public static NDArray cosFloat(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            float val= a.getData().get(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES);
            resArray.getData().set(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES,(float) Math.cos(val));
        }
        return resArray;
    }
    ...
    public static NDArray cosDouble(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            double val = a.getData().get(ValueLayout.JAVA_DOUBLE, i * DB_BYTES);
            resArray.getData().set(ValueLayout.JAVA_DOUBLE, i * DB_BYTES, Math.cos(val));
        }
    ...
    public static NDArray tanFloat(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            float val= a.getData().get(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES);
            resArray.getData().set(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES,(float) Math.tan(val));
        }
        return resArray;
    }
    ...
    public static NDArray tanDouble(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            double val = a.getData().get(ValueLayout.JAVA_DOUBLE, i * DB_BYTES);
            resArray.getData().set(ValueLayout.JAVA_DOUBLE, i * DB_BYTES, Math.tan(val));
        }
    ...
    public static NDArray cotFloat(NDArray a, NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            float val= a.getData().get(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES);
            resArray.getData().set(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES,(float) (1.0 / Math.tan(val)));
        }
        return resArray;
    }
    ...
    public static NDArray cotDouble(NDArray a, NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            double val = a.getData().get(ValueLayout.JAVA_DOUBLE, i * DB_BYTES);
            resArray.getData().set(ValueLayout.JAVA_DOUBLE, i * DB_BYTES, (1.0 / Math.tan(val)));
        }
    ...
    public static NDArray coshFloat(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            float val= a.getData().get(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES);
            resArray.getData().set(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES,(float) Math.cosh(val));
        }
        return resArray;
    }
    ...
    public static NDArray coshDouble(NDArray a,NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            double val = a.getData().get(ValueLayout.JAVA_DOUBLE, i * DB_BYTES);
            resArray.getData().set(ValueLayout.JAVA_DOUBLE, i * DB_BYTES, Math.cosh(val));
        }
    ...
    public static NDArray cothFloat(NDArray a, NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            float val= a.getData().get(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES);
            resArray.getData().set(ValueLayout.JAVA_FLOAT,i*FLOAT_BYTES,(float) (1.0 / Math.tanh(val)));
        }
        return resArray;
    }
    ...
    public static NDArray cothDouble(NDArray a, NDArray resArray){
        ...
        for(; i< a.getSize(); i++){
            double val = a.getData().get(ValueLayout.JAVA_DOUBLE, i * DB_BYTES);
            resArray.getData().set(ValueLayout.JAVA_DOUBLE, i * DB_BYTES, (1.0 / Math.tanh(val)));
        }
