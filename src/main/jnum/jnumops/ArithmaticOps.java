...
public class ArithmaticOps {
    ...
    public static NDArray addFloat(NDArray a, NDArray b, NDArray resArray) {
        if (a.isContiguous() && b.isContiguous() && resArray.isContiguous()) {
            ...
            for (; i < a.size; i++) {
                ...
                resArray.data.setAtIndex(ValueLayout.JAVA_FLOAT, i, (float)(valA + valB));
            }
        } else {
            ...
            while (iterA.hasNext) {
                ...
                for(int k=0; k < validLanes; k++) {
                    bufA[k] = a.data.getAtIndex(ValueLayout.JAVA_FLOAT, mapA[k]);
                    bufB[k] = b.data.getAtIndex(ValueLayout.JAVA_FLOAT, mapB[k]);
                }
                ...
                for(int k=0; k < validLanes; k++) {
                    resArray.data.setAtIndex(ValueLayout.JAVA_FLOAT, mapRes[k], bufRes[k]);
                }
            }
        }
        return resArray;
    ...
    public static NDArray addFloat(NDArray a, float b, NDArray resArray) {
        ...
        if (a.isContiguous() && resArray.isContiguous()) {
            ...
            for (; i < a.size; i++) {
                float valA = a.data.getAtIndex(ValueLayout.JAVA_FLOAT, i);
                resArray.data.setAtIndex(ValueLayout.JAVA_FLOAT, i, (float)(valA + b));
            }
        } else {
            int vl = SPECIES.length();
            int[] mapA = new int[vl];
    ...
    public static NDArray addDouble(NDArray a, NDArray b, NDArray resArray) {
        if (a.isContiguous() && b.isContiguous() && resArray.isContiguous()) {
            ...
            for (; i < a.size; i++) {
                ...
                resArray.data.setAtIndex(ValueLayout.JAVA_DOUBLE, i, (double)(valA + valB));
            }
        } else {
            ...
            while (iterA.hasNext) {
                ...
                for(int k=0; k < validLanes; k++) {
                    bufA[k] = a.data.getAtIndex(ValueLayout.JAVA_DOUBLE, mapA[k]);
                    bufB[k] = b.data.getAtIndex(ValueLayout.JAVA_DOUBLE, mapB[k]);
                }
                ...
                for(int k=0; k < validLanes; k++) {
                    resArray.data.setAtIndex(ValueLayout.JAVA_DOUBLE, mapRes[k], bufRes[k]);
                }
            }
        }
        return resArray;
    ...
    public static NDArray addDouble(NDArray a, double b, NDArray resArray) {
        ...
        if (a.isContiguous() && resArray.isContiguous()) {
            ...
            for (; i < a.size; i++) {
                double valA = a.data.getAtIndex(ValueLayout.JAVA_DOUBLE, i);
                resArray.data.setAtIndex(ValueLayout.JAVA_DOUBLE, i, (double)(valA + b));
            }
        } else {
            int vl = SPECIESDB.length();
            int[] mapA = new int[vl];
    ...
    public static NDArray addInt(NDArray a, NDArray b, NDArray resArray) {
        if (a.isContiguous() && b.isContiguous() && resArray.isContiguous()) {
            ...
            for (; i < a.size; i++) {
                ...
                resArray.data.setAtIndex(ValueLayout.JAVA_INT, i, (int)(valA + valB));
            }
        } else {
            ...
            while (iterA.hasNext) {
                ...
                for(int k=0; k < validLanes; k++) {
                    bufA[k] = a.data.getAtIndex(ValueLayout.JAVA_INT, mapA[k]);
                    bufB[k] = b.data.getAtIndex(ValueLayout.JAVA_INT, mapB[k]);
                }
                ...
                for(int k=0; k < validLanes; k++) {
                    resArray.data.setAtIndex(ValueLayout.JAVA_INT, mapRes[k], bufRes[k]);
                }
            }
        }
        return resArray;
    ...
    public static NDArray addInt(NDArray a, int b, NDArray resArray) {
        ...
        if (a.isContiguous() && resArray.isContiguous()) {
            ...
            for (; i < a.size; i++) {
                int valA = a.data.getAtIndex(ValueLayout.JAVA_INT, i);
                resArray.data.setAtIndex(ValueLayout.JAVA_INT, i, (int)(valA + b));
            }
        } else {
            int vl = SPECIESINT.length();
            int[] mapA = new int[vl];
